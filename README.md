...
| PROJECT | DESCRIPTION |
|--------------------------------|-------------|
| [SQLMAP Auditor](https://github.com/BroadbentT/SQLMAP-AUDITOR) | A python script file to perform automated audit tests against web application projects using SQLMAP.|
