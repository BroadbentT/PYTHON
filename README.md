...
|--------------------------------|-------------|
| [BASE64/AES Encoder](https://github.com/BroadbentT/PCAP-CRACKER) | A python script file that creates and reads BASE64/AES encoded text strings, using salt and key. |
