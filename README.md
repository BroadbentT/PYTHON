...
| [.Pub Cracker
   .Xml Cracker](https://github.com/BroadbentT/RSA-CRACKER) |A python script file that cracks RSA encrypted messages via a weak public key, or a XML mathmatical calculation.|
