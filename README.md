...
| FILENAME                       | DESCRIPTION |
|--------------------------------|-------------|
| [StegMaster](https://github.com/BroadbentT/STEG-MASTER) |A python script file to forensicallly analyse encrypted data embedded within images. |
|[MemoryMaster](https://github.com/BroadbentT/Memory-Manager) | A python script file to forensically investigate and analyse memory dump iamges for Windows and Linux. |
