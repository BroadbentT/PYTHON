...
| [Master Control Program](https://github.com/BroadbentT/MASTER-CONTROL-PROGRAM) | A python script file to remotely analyse and exploit Microsoft Windows system via impacket.|
