...
| PROJECT | DESCRIPTION |
|--------------------------------|-------------|
| [R2LibcRop](https://github.com/BroadbentT/ROP) | An experimental python script file to perform Return-oriented Programming (ROP) exploits on vulnerable elf files automatically.| 
